            ...
            <div class="col-sm-6 col-sm-offset-2">
                <form class="form-horizontal" action="${pageContext.request.contextPath}/AdminServlet" method="post"  role="form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="deparid" class="form-control" id="inputXxddm" >
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="inputXxdmc" class="col-sm-4 control-label">学习点名称</label>
                        <div class="col-sm-8">
                            <input type="text" name="xxdd" class="form-control" id="inputXxdmc" >
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="inputXxddz" class="col-sm-4 control-label">学习点地址</label>
                        <div class="col-sm-8">
                            <input type="text" name="dizhi" class="form-control" id="inputXxddz" placeholder="">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="inputLxr" class="col-sm-4 control-label">联系人</label>
                        <div class="col-sm-8">
                            <input type="text" name="lianxiren" class="form-control" id="inputLxr" >
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="ytdw" class="form-control" id="inputYtdw">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input  type="text"  name="yongdate" class="form-control" id="inputYongdate">
                        </div>
                    </div>
                    <div class="form-group">
                        <label  for="inputHuze" class="col-sm-4 control-label">负责人</label>
                        <div class="col-sm-8">
                            <input type="text" name="huze" class="form-control" id="inputHuze">
                        </div>
                    </div>
                    <div class="form-group">
