...
<body>
<!-- 以下是头部header -->
<iframe width="101%" height="65" name="top" frameborder="0" src="${pageContext.request.contextPath}/jsps/admin/header.jsp" scrolling="no" style="margin-left: -7px; "></iframe>
...
<div id="tabs">
    ...
    <div>		
         ...
         <iframe name="sidebar" src="${pageContext.request.contextPath}/jsps/admin/sidebar.jsp" width="100%" height="91%" frameborder="0"></iframe>
    </div>
</div>
