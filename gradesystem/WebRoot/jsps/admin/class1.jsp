...
<!-- 以下是内容主体部分mainbody -->  
<div class="mainbody">
    <p>当前位置：教师-->教师成绩录入-->计算机科学与技术15(1)</p>
    <div>
    <form  name="" id="" metdod="post" action="">
            <!-- 第一个表格 -->
            ...
            <table class="table table-bordered table-condensed"> 
                ...
                <tr>
                    ...
                    <td style="width: 100%">
                        <label>平时(%):</label>
                        <input type="text" name="" id="text_formula_1" size="4">    
                        <label>期中(%):</label>
                        <input type="text" name="" id="text_formula_2" size="4">
                        <label>实验(%):</label>
                        <input type="text" name="" id="text_formula_3" size="4">
                        <label>期末(%):</label>
                        <input type="text" name="" id="text_formula_4" size="4">
