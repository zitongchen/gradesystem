...
<div class="mainbody">
    ...
    <div>
    <form target="body" name="" id="" metdod="post" action="${pageContext.request.contextPath}/adminServlet">
            ...
            <table class="table table-bordered table-condensed">
                ...
                <tr>
                    <td>教师姓名：</td>
                    <td><span>${sessionScope.session_admin.name}</span></td>
                    <td>课程名称：</td>
	...
	<input type="hidden" name="classId" value="${requestScope.classes.class_id}"/>
	<input type="hidden" name="expacount" value="${sessionScope.session_admin.expacount}"/>
        <table class="table table-bordered table-condensed">
            <tr>
                <td style="width: 100%">
