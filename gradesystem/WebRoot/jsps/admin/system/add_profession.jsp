            ...
            <div class="col-sm-6 col-sm-offset-2">
                <form class="form-horizontal" action="${pageContext.request.contextPath}/AdminServlet" method="post"  role="form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="zydm" class="form-control" id="inputZydm" required="required">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="inputZymc" class="col-sm-4 control-label">专业名称</label>
                        <div class="col-sm-8">
                            <input type="text" name="zymc" class="form-control" id="inputZymc" required="required">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="inputXxxs" class="col-sm-4 control-label">学习形式</label>
                        <div class="col-sm-8">
                            <input type="text" name="xxxs" class="form-control" id="inputXxxs" placeholder=""required="required">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="xznx" class="form-control" id="inputXznx" required="required">
                        </div>
                    </div>
                    <div class="form-group">
                        <label  for="inputXz" class="col-sm-4 control-label">学制</label>
                        <div class="col-sm-8">
                            <input type="text" name="xz" class="form-control" id="inputXz" required="required">
                        </div>
                    </div>
                    <div class="form-group">
